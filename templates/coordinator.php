...
if (isset($_POST['add_course'])) {
    ...
    $course_l = $_POST['course_l'];
    $course_t = $_POST['course_t'];
    $course_p = $_POST['course_p'];
    $course_r = $_POST['course_r'];
...
<form method="POST" action="co.php">
    <input type="hidden" name="selected_sem" value="<?php echo htmlspecialchars($selected_sem); ?>">
